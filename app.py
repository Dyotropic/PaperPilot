...
此处保留：主题、AppState、StudyCopilot Agent 面板、导航、page_switcher、main()。
"""
import asyncio
import json
import logging
...
def _project_actions_menu():
    ...
    def _safe(cb):
        try:
            ...
            logger.warning(f"[sidebar] 课题操作失败: {ex}")
